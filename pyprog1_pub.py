# FIRST BASIC ATTEMPT AT TEXT ANALYSIS (M. Aquino, August 2020)
#   OBJECTIVES: lightly pre-process DNC and RNC nomination acceptance speeches (Biden and Trump);
#   After removing common stop words, look at frequency distribution of words for simple comparison;
#   Test out using NLTK and MATPLOTLIB.
...
# Will actually want to read text from "biden.txt"; currently just pasting in desired text data.
#   ~I attempted to load from *.txt but ran into errors. This will be the next thing to learn.

# Begin NLTK Text Pre-processing: tokenize by word and remove punctuation.
from nltk.tokenize import word_tokenize
tokewords = word_tokenize(text)

# Convert to lower case
tokewordslc = [word.lower() for word in tokewords]
twsans_punc = [word for word in tokewordslc if word.isalnum()]

print("Original text:")
print(text)
print("==================================")
print("Tokenized word list without punctuation:")
print(twsans_punc)
...
fdist = FreqDist(twsans_punc)
print(fdist)

print("And, these words are the most common:")
print(fdist.most_common(5))

# Removing stop words.
print("For comparison, this is the data set with common stop words removed:")

from nltk.corpus import stopwords

stop_words = set(stopwords.words("english"))
filtered_sent = []
for w in twsans_punc:
    if w not in stop_words:
        filtered_sent.append(w)
print(filtered_sent)

fdist_filt = FreqDist(filtered_sent)
print(fdist_filt)

print("And, these words are the most common, after removal of stop words:")
print(fdist_filt.most_common(5))

# Marker for end of my script:
print("")  # line break attempt
print("************")
print("fin. ~Lito~")
print("************")
...
fdist_filt.plot(30, cumulative=False)
plt.show()
# END